...
init_angle = 180;             % deg
x0 = [0; 0; init_angle/180*pi; 0];   % initial pose
disp(x0);
...
clf;
tiledlayout(4, 2, "TileIndexing","rowmajor","TileSpacing","tight","Padding","tight");
nexttile;
...
if saveData
    ...
    fileName_data = "data_MPC_init_" + string(init_angle) + ".xlsx";
